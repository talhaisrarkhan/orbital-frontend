...
export const paths = {
  ...
  dashboard: {
    ...
    project: {
      ...
      sprint: (projectId: string, sprintId: string) => `${ROOTS.DASHBOARD}/project/${projectId}/sprint/${sprintId}`,
      board: (projectId: string, boardId: string) => `${ROOTS.DASHBOARD}/project/${projectId}/board/${boardId}`,
    },
  },
};
