...
const InputOTPSlot = React.forwardRef(({ index, className, ...props }, ref) => {
  ...
  return (
    (<div
      ref={ref}
      className={cn(
        "relative flex h-10 w-10 items-center justify-center border-y border-r border-neutral-200 text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md dark:border-gray-500",
